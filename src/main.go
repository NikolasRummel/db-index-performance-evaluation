...
func ReadFlagsOrDefault() bench.Config {
	...
	flag.IntVar(&cfg.PointQueryCount, "point-queries", 50_000, "Number of point queries to run")
	...
	flag.IntVar(&cfg.LogInterval, "log-interval", 100, "Logging interval")
	...
	flag.IntVar(&cfg.T2MaxSize, "t2-max-size", 1_000_000, "T2 range query max size")
	flag.Parse()
