...
func ReadFlagsOrDefault() bench.Config {
	...
	flag.IntVar(&cfg.DatasetSize, "dataset-size", 10_000_000, "Number of entries in the dataset")
	...
	flag.IntVar(&cfg.T2MaxSize, "t2-max-size", 4_194_305, "T2 range query max size")
	flag.Parse()
