...
func ReadFlagsOrDefault() bench.Config {
	...
	flag.IntVar(&cfg.WriteOpsTotal, "write-ops-total", 5_000_000, "Total write operations")
	flag.IntVar(&cfg.WriteOpsWindow, "write-ops-window", 100_000, "Write ops window size")
